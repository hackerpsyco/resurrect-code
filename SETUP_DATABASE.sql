-- ============================================================================
-- ANALYSIS AUTOMATION SYSTEM - DATABASE SETUP
-- ============================================================================
-- Run this SQL in Supabase Dashboard → SQL Editor to set up the database
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_analysis_automation_settings_user_id 
  ON analysis_automation_settings(user_id);

CREATE INDEX IF NOT EXISTS idx_analysis_reports_user_id 
  ON analysis_reports(user_id);

CREATE INDEX IF NOT EXISTS idx_analysis_reports_repository 
  ON analysis_reports(repository);

CREATE INDEX IF NOT EXISTS idx_analysis_reports_timestamp 
  ON analysis_reports(timestamp DESC);

CREATE INDEX IF NOT EXISTS idx_analysis_reports_report_id 
  ON analysis_reports(report_id);
...
-- Trigger for analysis_automation_settings
...
-- AND table_name IN ('analysis_automation_settings', 'analysis_reports');

-- Check if RLS is enabled
-- SELECT tablename, rowsecurity FROM pg_tables 
-- WHERE tablename IN ('analysis_automation_settings', 'analysis_reports');
...
-- DONE!
-- ============================================================================
-- The database is now set up. Next steps:
-- 1. Set SUPABASE_SERVICE_ROLE_KEY in Edge Functions → Secrets
